...
public class Mailing{
    ...
    public static void mailing(String path) throws Exception {
        ...
        final String moncompteEmail = "chedly104@gmail.com";
         final String to = "chedly.kchaou@esprit.tn";
        ...
        try{
            ...
            msg.setSubject("Bonjour chedly , Evenement ajouté ");
            Multipart con = new MimeMultipart();
            MimeBodyPart text =new MimeBodyPart();
            text.setText("Voici le QR code de cet Evenement");
    ...
    /*   public void sendEmail(String path) throws IOException {
           final String username ="chedly104@gmail.com";
        final String password ="esprit123456789";
        String from = "chedly104@gmail.com";
        String to = "chedly.kchaou@esprit.tn"; // change this 
        ...
        try{
            msg.setFrom(from);
            msg.addRecipient(Message.RecipientType.TO, new InternetAddress(to));
            msg.setSubject("Voiture ajouté ");
            Multipart con = new MimeMultipart();
            MimeBodyPart text =new MimeBodyPart();
            text.setText("Voici le QR code de cet Voiture");
            MimeBodyPart img = new MimeBodyPart();
            img.attachFile(path);
            con.addBodyPart(text);
            con.addBodyPart(img);
