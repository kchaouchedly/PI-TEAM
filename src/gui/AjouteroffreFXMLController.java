...
public class AjouteroffreFXMLController implements Initializable {
    ...
    @FXML
    private TableColumn<Offre, Integer> idaffoffre;
    @FXML
    ...
    Offre a =new Offre(Integer.parseInt(nbrplacesoff.getText()),nomoffreajout.getText(), nomguideoff.getText(), image,Float.parseFloat(prixoff.getText()) ,Date.valueOf(datedebutoff.getValue()), Date.valueOf(datefinoff.getValue()));
