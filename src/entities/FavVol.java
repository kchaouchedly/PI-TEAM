...
public class FavVol {
    ...
    public FavVol(int id, int NumVol, int nbrPlace, Date DateDepart, Date DateArrive, String VilleDepart, String VilleArrive, String imageVol, String typeV) {
        this.id = id;
        this.NumVol = NumVol;
    ...
    public FavVol(int NumVol, int nbrPlace, Date DateDepart, Date DateArrive, String VilleDepart, String VilleArrive, String imageVol, String typeV) {
        this.NumVol = NumVol;
        this.nbrPlace = nbrPlace;
        this.DateDepart = DateDepart;
        this.DateArrive = DateArrive;
    ...
    public String toString() {
        return "FavVol{" + "id=" + id + ", NumVol=" + NumVol + ", nbrPlace=" + nbrPlace + ", DateDepart=" + DateDepart + ", DateArrive=" + DateArrive + ", VilleDepart=" + VilleDepart + ", VilleArrive=" + VilleArrive + ", imageVol=" + imageVol + ", typeV=" + typeV + '}';
    }
