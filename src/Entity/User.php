...
class User implements UserInterface
{
  ...
  /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=ResChambre::class, mappedBy="user")
     */
    private $reschambre;
    ...
    {
        if (!$this->reschambre->contains($reschambre)) {
            $this->reschambre[] = $reschambre;
            $reschambre->setUser($this);
        }
    ...
    {
        if ($this->reschambre->removeElement($reschambre)) {
            // set the owning side to null (unless already changed)
            if ($reschambre->getUser() === $this) {
                $reschambre->setUser(null);
            }
        }
