...
public class TrackEmployeeController implements Initializable {
  ...
  //  public TabPane eTabpane;
    ...
    private final ObservableList<String> yearArray = FXCollections.observableArrayList("2019", "2020", "2021","2022");
    ...
    private final ObservableList<String> statusArray = FXCollections.observableArrayList("sport", "voyage","present", "voyage","present", "voyage","present", "voyage","present", "voyage","presnt",
            "sport", "voyage","sport", "voyage","sport", "voyage","sport", "absent","present", "absent","presnt",
            "sport", "voyage","voyage", "sport","sport", "voyage","present", "voyage","present", "voyage","sport");
    ...
    TableColumn<AttendenceClass, String> attributeColumn = new TableColumn<>("MOIS");
    TableColumn<AttendenceClass, String> groupColumn;

    private static final List<String> groups = Arrays.asList("DIMANCHE", "LUNDI", "MARDI", "MERCREDI", "JEUDI", "VENDREDI", "SAMEDI");
    private static final List<String> montharray = Arrays.asList("JANVIER", "FEVRIER", "MARS", "AVRIL", "MAI", "JUIN", "JUILLET", "AOUT", "SEPTEMBRE", "OCTOBRE", "NOVEMBRE", "DECEMBRE");
    ...
    private void buildYearTable(int year) throws SQLException {
        ...
        for (int i = 0; i < montharray.size(); i++) {
            ...
            for (int j = 0; j < dayarray.size(); j++) {
                //    int year=2024;
                if (montharray.get(i) == "JANVIER" || montharray.get(i) == "MARS" || montharray.get(i) == "MAI" || montharray.get(i) == "JUILLET" || montharray.get(i) == "AOUT" || montharray.get(i) == "OCTOBRE" || montharray.get(i) == "DECEMBRE") {
                ...
                } else if (montharray.get(i) == "FEVRIER") {
                ...
                if (montharray.get(i) == "AVRIL" || montharray.get(i) == "JUIN" || montharray.get(i) == "SEPTEMBRE" || montharray.get(i) == "NOVEMBRE") {
                    Calendar day = new GregorianCalendar(year, i, 1);
                    int dayOfWeek = day.get(Calendar.DAY_OF_WEEK);
                    switch (dayOfWeek) {
                        case 1:
