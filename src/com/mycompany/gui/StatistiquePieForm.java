...
public class StatistiquePieForm extends BaseForm {
    ...
    private double nbr_avis =26;
   private double  nbr_event=70;
  ...
  ;       
    ...
    public DefaultRenderer buildCatRendrer (int [] colors ){
     ...
     public void createPieCharForm(){
        double total= nbr_avis+nbr_event ; 
        double p=(nbr_avis *100)/total;
         double e=(nbr_event *100)/total;
       ...
       String []messages={
           "Statistiques Avis sur Evenement "
       };
