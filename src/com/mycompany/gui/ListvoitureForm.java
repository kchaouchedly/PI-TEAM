...
public class ListvoitureForm extends BaseForm{
  ...
  // addTab(swipe,res.getImage("back.png"),"","",res);
     ...
     rbs[0].setSelected(true);
        ...
        RadioButton mesListes = RadioButton.createToggle("Ajouter Voitures ", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Autres", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Agences ", barGroup);
        ...
        ArrayList<voiture> result= ServiceVoiture.getInstance().affichagevoiture();
