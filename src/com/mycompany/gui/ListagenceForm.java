 ...
 * @author LENOVO
 */
public class ListagenceForm extends BaseForm{
    
    Form  current ; 
    public ListagenceForm(Resources res ){
  ...
  // addTab(swipe,res.getImage("back.png"),"","",res);
     ...
     rbs[0].setSelected(true);
        ...
        RadioButton mesListes = RadioButton.createToggle("nos Voiture ", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Autres", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Ajouter agence ", barGroup);
        ...
        ArrayList<AgenceVoiture> result= ServiceAgenceVoiture.getInstance().affichageagence();
        for(AgenceVoiture rec : result ){
   ...
   private void addButton(Image img, AgenceVoiture rec, Resources res) {
      ...
      // ta.setEditable(false);
       ...
       Label nomtxt= new Label("nom:"+rec.getNomagence(),"NewsTopline2");
      ...
      // cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(BoxLayout.encloseX(nomtxt),BoxLayout.encloseX(typetxt)));
       ...
       if (dig.show("suppression","vous vouler supprimer cet agence?","annuler","oui")){
           dig.dispose();
       }
       else {
           dig.dispose();
           if (ServiceAgenceVoiture.getInstance().delete((int) rec.getId()))
           {
       ...
       update.addPointerPressedListener(l-> {
        ...
        new ModifierAgenceForm(res, rec).show();
        ...
        //cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(BoxLayout.encloseX(supp)));
         cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(BoxLayout.encloseX(nomtxt,supp,update),BoxLayout.encloseX(adressetxt)));
