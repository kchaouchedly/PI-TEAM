 ...
 * @author Hp
 */
public class FrontOffre  extends BaseForm{
      Form  current ; 
    public FrontOffre  (Resources res ){
         ...
         // ListeventForm a = new ListeventForm(res);
           // a.show();
            //refreshTheme();
              ...
              Button btnoff=new Button("Voir les Evenements ! "); 
            addStringValue("", btnoff); 
         btnoff.addActionListener(t->{
             new FrontEvenement(res).show();
          });
...
*/
      /*  partage.setSelected(true);
        ...
        ArrayList<Offres> result= ServiceOffres.getInstance().affichageoff();
        for(Offres rec : result ){
            String urlimage= "back-logo1.png";
    ...
    private void addTab(Tabs swipe,Label spacer ,  Image image, String string, String text, Resources res) {
       ...
       if(image.getHeight()>Display.getInstance().getDisplayHeight() / 2){
        ...
        swipe.addTab("", res.getImage("back-logo1.png"),page1);
    }
   ...
   private void addButton(Image img, Offres rec, Resources res) {
      ...
      // ta.setEditable(false);
       ...
       Label nomtxt= new Label("Nom Offre:"+rec.getNom(),"NewsTopline2");
       Label guidetxt =new Label ("Type:"+rec.getNomGuide(),"NewsTopline2");
    ...
    /*   Label supp= new Label("");
       ...
       if (dig.show("suppression","vous vouler supprimer ce event?","annuler","oui")){
           ...
           dig.dispose();
           if (ServiceOffres.getInstance().deleteoff(rec.getId()))
           {
      ...
      //  new ModifierEvenementForm(res, rec).show();
        new modifieroffreform(res, rec).show();
        ...
        //cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(BoxLayout.encloseX(supp)));
         cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(BoxLayout.encloseX(nomtxt),BoxLayout.encloseX(guidetxt)));
