 ...
 * @author LENOVO
 */
public class StatistiqueVForm extends BaseForm{
       private boolean drawOnMutableImage;
    private double nbr_voiture =26;
   private double  nbr_marque=70;
   
    
    Form current;
BaseForm form;
        public StatistiqueVForm(Resources res)  {
        ...
        addTab(swipe, res.getImage("back-logo.jpg"), spacer1, "Bienvenue");
        ...
        ButtonGroup barGroup = new ButtonGroup();
         RadioButton all = RadioButton.createToggle("Retour", barGroup);
       
        all.setUIID("SelectBar");
          all.addActionListener((e) -> {
              // InfiniteProgress ip = new InfiniteProgress();
       // final Dialog ipDlg = ip.showInifiniteBlocking();
        new AjoutvoitureForm(res).show();
  ...
  ;       
    ...
    public DefaultRenderer buildCatRendrer (int [] colors ){
     ...
     public void createPieCharForm(){
        double total= nbr_voiture+nbr_marque ; 
        double p=(nbr_voiture *100)/total;
         double e=(nbr_marque *100)/total;
         ...
         PieChart chart = new PieChart(buildDataset("title",Math.round(p),Math.round(e)),renderer);
      
       ChartComponent c = new  ChartComponent(chart);
       String []messages={
           "Statistiques sur les marque des voitures "
       };
       
        SpanLabel message = new SpanLabel(messages[0], "Bienvenue"); 
    ...
    private CategorySeries buildDataset(String title, double p, double e) {
          CategorySeries series = new CategorySeries(title); 
            series.add("voiture ",p);
        series.add("marque",e);
