...
public class modifieroffreform extends BaseForm{
     ...
     Form current ; 
    public modifieroffreform(Resources res , Offres e )
    {
       ...
       // ToolBar tb = new ToolBar(true); 
        ...
        TextField type= new TextField(e.getNomGuide(),"Nom Guide",20,TextField.ANY);
        ...
        nom.setSingleLineTextArea(true);
         ...
         btnupdatee.addPointerPressedListener(l->{
             ...
             e.setNomGuide(type.getText());
     
         if(ServiceOffres.getInstance().updateoff(e)){
