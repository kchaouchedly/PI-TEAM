 ...
 * @author Hp
 */
public class FrontEvenement extends BaseForm{
    
    Form  current ; 
    public FrontEvenement(Resources res ){
    ...
    // partage.addActionListener(l->{
      ...
      /*  Button btnstat=new Button("Statistique ! "); 
          ...
          btnmapeve.addActionListener(t->{
           ...
           Button btnoff=new Button("Voir les Offres ! "); 
            addStringValue("", btnoff); 
         btnoff.addActionListener(t->{
             new FrontOffre(res).show();
          });
        

        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(3, liste),
