 ...
 * @author Hp
 */
public class TriEveForm extends BaseForm{
    
     Form  current ; 
    public TriEveForm(Resources res ){
  ...
  // addTab(swipe,res.getImage("back.png"),"","",res);
     ...
     rbs[0].setSelected(true);
        ...
        RadioButton mesListes = RadioButton.createToggle("Retour  ", barGroup);
      ...
      //  partage.setSelected(true);
        ...
        addOrientationListener(e -> {
           ...
           Button btnoff=new Button("Retour ! "); 
        ...
        ArrayList<Evenement> result= ServiceEvenement.getInstance().affichagetrieve();
