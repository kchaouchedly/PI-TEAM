 ...
 * @author LENOVO
 */
public class Listvvoituretri extends BaseForm {
    
 Form  current ; 
    public Listvvoituretri(Resources res ){
  ...
  // addTab(swipe,res.getImage("back.png"),"","",res);
     ...
     rbs[0].setSelected(true);
        ...
        RadioButton mesListes = RadioButton.createToggle("nos voitures", barGroup);
        ...
        ArrayList<voiture> result= ServiceVoiture.getInstance().triparmarque();
        for(voiture rec : result ){
   ...
   private void addButton(Image img, voiture rec, Resources res) {
      ...
      // cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(BoxLayout.encloseX(nomtxt),BoxLayout.encloseX(typetxt)));
       ...
       if (dig.show("suppression","vous vouler supprimer cet voiture?","annuler","oui")){
           dig.dispose();
       }
       else {
           dig.dispose();
           if (ServiceVoiture.getInstance().delete((int) rec.getId()))
           {
               new ListvoitureForm(res).show(
       ...
       update.addPointerPressedListener(l-> {
        ...
        new ModifierVoitureForm(res, rec).show();
        ...
        //cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(BoxLayout.encloseX(supp)));
         cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(BoxLayout.encloseX(marquetxt,supp,update),BoxLayout.encloseX(typetxt)));
